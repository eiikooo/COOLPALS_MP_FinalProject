<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="COOLPALS_MP_FinalProject.Register" %>
<!DOCTYPE html>
<html lang="en">
<head runat="server">
    <title>PairEd - Register</title>
    <meta charset="UTF-8" />
    ...
    <div class="page">
        ...
        <div class="right">
            <div class="right-inner">
                ...
                <p class="panel-sub">Join your school's skill-sharing network today.</p>
                ...
                <div class="field-row">
                    <div>
                        ...
                        <asp:TextBox ID="txtFirstName" runat="server" CssClass="field-input" placeholder="Juan"></asp:TextBox>
                    </div>
                    <div>
                        <label class="field-label" for="<%= txtLastName.ClientID %>">Last Name</label>
                        <asp:TextBox ID="txtLastName" runat="server" CssClass="field-input" placeholder="dela Cruz"></asp:TextBox>
                    </div>
                </div>
                ...
                <div class="field-group">
                    ...
                    <asp:TextBox ID="txtConfirmPassword" runat="server" TextMode="Password" CssClass="field-input" placeholder="••••••••"></asp:TextBox>
                </div>

                <asp:Button ID="btnRegister" runat="server" Text="Create Account" OnClick="RegisterUser" CssClass="btn-primary" />
